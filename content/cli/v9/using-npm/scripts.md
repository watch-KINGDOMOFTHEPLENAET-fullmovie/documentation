...
#### [`npm cache add`](/cli/v9/commands/npm-cache)

* `prepare`

#### [`npm ci`](/cli/v9/commands/npm-ci)
...
#### [`npm diff`](/cli/v9/commands/npm-diff)
...
#### [`npm run <user defined>`](/cli/v9/commands/npm-run-script)
...
#### A Note on a lack of [`npm uninstall`](/cli/v9/commands/npm-uninstall) scripts
...
See [`package.json`](/cli/v9/configuring-npm/package-json) for more on package configs.
...
* Try not to use scripts to do what npm can do for you.  Read through
  [`package.json`](/cli/v9/configuring-npm/package-json) to see all the things that you can specify and enable
